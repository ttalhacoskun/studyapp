...
import 'package:studyapp/model/flash_card.dart';

class FlashcardPage extends StatefulWidget {
  final List<Flashcard> flashcards;

  FlashcardPage({Key? key, required this.flashcards}) : super(key: key);
                            ...
                            child: Transform.rotate(
                              ...
                              child: FlipCard(
                                ...
                                front: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      widget.flashcards[_currentIndex].term,
                                      style: TextStyle(
                                        fontSize: 24,
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold,
                                ...
                                back: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      widget.flashcards[_currentIndex].explanation,
                                      style: TextStyle(
                                        fontSize: 24,
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold,
